        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-primary mb-3" href="{{ route('user.create') }}" role="button">Tambah Data</a>
                    <table class="table">
                        <thead>
                          <tr>
                            <th scope="col">No</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $bio->user_id }}</td>
                                <td>
                                    <form action="{{ route('user.destroy',$bio->id) }}" method="POST">
                                    <a class="btn btn-info mb-3" href="{{ route('user.show',$bio->id) }}">Tampil</a>
                                    <a class="btn btn-warning mb-3" href="{{ route('user.edit',$bio->id) }}" role="button">Edit</a>
